...
def tambah_buku(banyakBuku):
    for i in range (banyakBuku):
        judulBuku = input("Input its title book here: ").lower()
...
while True:
    ...
    try:
        ...
        if userChoice == 1:
            banyakBukuUser = int(input("How many books do you want to add to your own list? "))
            ...
            print("remember, all of the title are lowercase 'cause we avoid crash program where user is a bit naughty, haha\n")
        elif userChoice == 5:
        ...
        print(f"\nERROR! There's a problem here: {e}")