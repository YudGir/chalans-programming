...
data_baru = [] #ini list baru guna nyimpen angka genap nantinya

for x in data:
    if x % 2 == 0:
        angka_baru = x * 2 #kita simpan hasil dari angka genap tersebut yg dikalikan dengan 2 ke dalam variabel angka_baru
        data_baru.append(angka_baru) #kita tambahkan setiap hasil perkalian ke dalam list baru, yaitu data_baru

print(data_baru) #print, deh, hihi